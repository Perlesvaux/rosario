...
const singlePress = () => set({type: "next"})
  ...
  return (
    <div className={ `bg-gray-300 grid grid-cols-3 gap-0 relative overflow-hidden w-full flex-shrink-0` } >

      <section className="col-span-3 relative w-full aspect-[812/899]">
        <Image
          className=""
          src={misterio.imagen}
          alt={misterio.titulo}
