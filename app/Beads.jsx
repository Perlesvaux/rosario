...
function Bead ({getter, setter}){
  ...
  return <button 
    onClick={setter}
    className={`${getter.cuenta>=10? 'bg-rose-700 ':'bg-gray-800'} mt-4 px-4 py-2 col-span-1 text-white rounded hover:bg-blue-500 transition flex items-center justify-center`}
    > 
